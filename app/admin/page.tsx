    ...
    <ProtectedRoute requiredRole="admin" redirectTo="/dashboard">
      <section className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-8 px-6 py-16">
        <MotionDiv
          ...
          className="space-y-3"
        >
          <h2 className="text-4xl font-semibold text-white">Reward Orchestration Hub</h2>
          <p className="text-sm text-white/70">
            Tune fragment values, rarity, and cashout thresholds. Changes apply instantly across the unlock and vault flows.
          </p>
        </MotionDiv>
